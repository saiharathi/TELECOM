<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Backend.Master" CodeBehind="Search Connection.aspx.cs" Inherits="TBSProject.Search_Connection" %>
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">  
             

   
       <center> <asp:Label ID="Label1" runat="server" Text="Search Connection"></asp:Label></center>
